...
use App\Models\chercheur as Modelschercheur;
use Exception;
...
class chercheurController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function verifierChercheur(Request $request){
        $chercheur = chercheur::where('id','=',$request->idDTU)->first();
        if ($chercheur){
            $chercheur->is_verified = '1' ;
            $chercheur->save();
        }
        return back();
    }

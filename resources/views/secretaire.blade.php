...
<body>
    ...
    <div class="container mt-2">
        <div class="row">
            ...
            <form class="col-md-6" action="{{route('connexion-secretaire')}}" method="POST">
                @csrf
                ...
                @endif
                <div class="text-center">
                    <div class="font-weight-bold" >Bienvenue Secretaire </div>
                </div>
                
                <!-- Email input -->
                <div class="form-outline mb-2">
                    <label class="form-label fw-bold ms-2" for="email">Email  : </label>
